...
public class RegistroService {
    ...
    //Metodo: para va activar un usuario via correo enviado por medio del link
    ...
    //Se utiliza cuando finalmente si se terminade registrar el usuario, ya con foto
    ...
    //Primer metodo para crear parcialmente un usuario y se envia un link por correo
